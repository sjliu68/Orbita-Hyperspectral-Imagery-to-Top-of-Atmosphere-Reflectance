...
fp = r'D:\Downloads\HAM2_20190125220146_0011_L1_MSS_CCD2'
...
imx = im.RasterXSize
imy = im.RasterYSize
outdata = gdal.GetDriverByName('GTiff').Create(name+'.tif', imx, imy, 11, gdal.GDT_UInt16)
bandcount = 0
for _fp in fp1:
    print(_fp)
#    if count+1 not in [1,2,3,7,12,14,26,27,28,31,32]:
#        count += 1
#        continue
