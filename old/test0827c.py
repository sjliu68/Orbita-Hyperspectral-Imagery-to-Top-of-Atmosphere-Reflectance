...
fps = glob.glob('D:/hsi3/*MSS_CCD*')
for fp in fps:
#    fp = r'D:\Downloads\HAM2_20181001214539_0004_L1_MSS_CCD2'
    ...
    imx = im.RasterXSize
    imy = im.RasterYSize
    outdata = gdal.GetDriverByName('GTiff').Create(name+'.tif', imx, imy, 4, gdal.GDT_UInt16)
    bandcount = 0
    for _fp in fp1:
        print(_fp)
